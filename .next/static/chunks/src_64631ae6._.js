(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_64631ae6._.js", {
...
function SiteHeader() {
    ...
    const [isMetaMaskInstalled, setIsMetaMaskInstalled] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SiteHeader.useEffect": ()=>{
            const handleAccountsChanged = {
                "SiteHeader.useEffect.handleAccountsChanged": (accounts)=>{
                    if (accounts.length > 0) {
                        ...
                        toast({
                            title: "Disconnected",
                            description: "MetaMask account disconnected."
                        });
                    }
                }
            }["SiteHeader.useEffect.handleAccountsChanged"];
            const handleChainChanged = {
                "SiteHeader.useEffect.handleChainChanged": (_chainId)=>{
                    toast({
                        title: "Network Changed",
                        description: "Please ensure you are on the correct network. Reloading..."
                    });
                    setTimeout({
                        "SiteHeader.useEffect.handleChainChanged": ()=>window.location.reload()
                    }["SiteHeader.useEffect.handleChainChanged"], 1500);
                }
            }["SiteHeader.useEffect.handleChainChanged"];
            if (typeof window.ethereum !== 'undefined') {
                setIsMetaMaskInstalled(true);
                window.ethereum.on('accountsChanged', handleAccountsChanged);
                window.ethereum.on('chainChanged', handleChainChanged);
                const checkIfWalletIsConnected = {
                    "SiteHeader.useEffect.checkIfWalletIsConnected": async ()=>{
                        try {
                ...
                }["SiteHeader.useEffect.checkIfWalletIsConnected"];
    ...
    const displayAddress = account ? `${account.substring(0, 6)}...${account.substring(account.length - 4)}` : "Connect Wallet";
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("header", {
        className: "sticky top-0 z-50 w-full border-b border-border/40 bg-black text-primary-foreground cursor-rainbow",
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$sheet$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["SheetTrigger"], {
                                    ...
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                        variant: "outline",
                                        size: "icon",
                                        className: "md:hidden text-foreground hover:text-accent-foreground",
                                        children: [
...
_s(SiteHeader, "kd5xHlbbXdUVgceM0kb3x1f0bMs=", false, function() {
    return [
...
//# sourceMappingURL=src_64631ae6._.js.map